...
Origen: D1 del bloqueante de `reviews/modelo-datos-rondas.md`; D2 y D3 de un hallazgo del builder en H2, acotado tras verificar la matemática (su propuesta inicial, `ceil(n/k)` para todo `n` impar, metía **una ronda de más** —un mes de liga— en todos los tamaños impares con el cupo por defecto `k=2`).
